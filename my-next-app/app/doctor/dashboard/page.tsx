        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              {/* Avatar Circle */}
              {doctor.image ? (
                <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-[#91C8E4] shadow-md">
                  <Image
                    src={doctor.image}
                    alt={doctor.name}
                    width={48}
                ...
                <div className="w-12 h-12 rounded-full bg-linear-to-br from-[#91C8E4] to-[#4682A9] flex items-center justify-center text-white font-bold text-sm shadow-md">
                  {getDoctorInitials()}
                </div>
              )}
              <div>
                <h1 className="text-xl font-bold text-gray-900">Hello, {doctor.name.split(' ')[1] || doctor.name.split(' ')[0]}</h1>
            ...
            <div className="flex items-center space-x-2">
              ...
              <button 
                ...
                className="ml-2 flex items-center gap-2 px-4 py-2 bg-red-50 hover:bg-red-100 text-red-600 rounded-full transition-all font-medium text-sm"
              >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-5 hover:shadow-lg transition-all">
            <div className="flex items-center justify-between mb-3">
              <div className="w-11 h-11 bg-[#91C8E4]/20 rounded-xl flex items-center justify-center">
          ...
          <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-5 hover:shadow-lg transition-all">
            <div className="flex items-center justify-between mb-3">
              <div className="w-11 h-11 bg-[#749BC2]/20 rounded-xl flex items-center justify-center">
                <Users className="w-5 h-5 text-[#4682A9]" />
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-5 hover:shadow-lg transition-all">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-xs font-semibold text-yellow-600 bg-yellow-50 px-2.5 py-1 rounded-full">★ {doctor.rating}</span>
            </div>
            <h3 className="text-3xl font-bold text-gray-900 mb-1">{doctor.rating}</h3>
          ...
          <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-5 hover:shadow-lg transition-all">
            ...
            <h3 className="text-3xl font-bold text-gray-900 mb-1">{stats.reviewCount}</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl shadow-md border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-5">
              ...
              <Link href="/doctor/appointments" className="text-sm font-semibold text-[#4682A9] hover:text-[#749BC2] transition-colors flex items-center gap-1">
            ...
            {appointments.length > 0 ? (
              <div className="space-y-3">
                {appointments.map((appointment) => (
                  <div
                    key={appointment.id}
                    className="flex items-center justify-between p-4 bg-[#FFFBDE] rounded-xl border border-gray-100 hover:border-[#91C8E4] hover:shadow-md transition-all cursor-pointer group"
                  >
                    <div className="flex items-center space-x-4">
                      {/* Patient Avatar */}
                      <div className="w-12 h-12 bg-linear-to-br from-[#91C8E4] to-[#4682A9] rounded-xl flex items-center justify-center text-white font-bold text-sm shadow-sm">
                        {appointment.patientName.split(' ').map(n => n[0]).join('')}
                      </div>
                      
                      {/* Info */}
                      <div>
                        <h3 className="font-semibold text-gray-900 group-hover:text-[#4682A9] transition-colors">{appointment.patientName}</h3>
                    ...
                    <div className="text-right">
                      <span className="inline-flex items-center gap-1.5 bg-[#91C8E4]/20 text-[#4682A9] px-3 py-1.5 rounded-lg text-sm font-medium">
            ...
            <Link href="/doctor/appointments">
              <button className="w-full mt-5 py-3 bg-linear-to-r from-[#91C8E4] to-[#4682A9] hover:from-[#749BC2] hover:to-[#4682A9] text-white rounded-xl font-semibold transition-all shadow-md hover:shadow-lg">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-6">
              ...
              <div className="space-y-4 text-sm">
                <div>
                  <p className="text-gray-500 text-xs mb-1 font-medium">Speciality</p>
                  <p className="font-semibold text-gray-900">{doctor.speciality}</p>
                </div>
                <div>
                  <p className="text-gray-500 text-xs mb-1 font-medium">Experience</p>
                  <p className="font-semibold text-gray-900">{doctor.experience}+ years</p>
                </div>
                <div>
                  <p className="text-gray-500 text-xs mb-1 font-medium">Consultation Fee</p>
            ...
            <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-6">
              ...
              <div className="space-y-2">
                <Link
                  ...
                  className="flex items-center justify-between p-3 bg-[#e9e8da] hover:bg-linear-to-r hover:from-[#91C8E4] hover:to-[#749BC2] rounded-xl transition-all group border border-transparent hover:border-[#91C8E4]"
                >
                  <div className="flex items-center space-x-3">
                    <div className="w-10 h-10 bg-[#91C8E4] group-hover:bg-white rounded-xl flex items-center justify-center transition-all">
                      <Calendar className="w-5 h-5 text-white group-hover:text-[#4682A9] transition-all" />
                    </div>
                    <span className="font-medium text-gray-800 group-hover:text-white text-sm transition-all">Manage Schedule</span>
                  </div>
                ...
                <Link
                  ...
                  className="flex items-center justify-between p-3 bg-[#e9e8da] hover:bg-linear-to-r hover:from-[#749BC2] hover:to-[#4682A9] rounded-xl transition-all group border border-transparent hover:border-[#749BC2]"
                >
                  <div className="flex items-center space-x-3">
                    <div className="w-10 h-10 bg-[#749BC2] group-hover:bg-white rounded-xl flex items-center justify-center transition-all">
                      <Users className="w-5 h-5 text-white group-hover:text-[#4682A9] transition-all" />
                    </div>
                    <span className="font-medium text-gray-800 group-hover:text-white text-sm transition-all">View Patients</span>
                  </div>
                  <ChevronRight className="w-5 h-5 text-gray-400 group-hover:text-white transition-all" />
                </Link>
                ...
                <Link
                  href="/doctor/profile"
                  className="flex items-center justify-between p-3 bg-[#e9e8da] hover:bg-linear-to-r hover:from-[#4682A9] hover:to-[#749BC2] rounded-xl transition-all group border border-transparent hover:border-[#4682A9]"
                >
                  <div className="flex items-center space-x-3">
                    <div className="w-10 h-10 bg-[#4682A9] group-hover:bg-white rounded-xl flex items-center justify-center transition-all">
                    ...
                    <span className="font-medium text-gray-800 group-hover:text-white text-sm transition-all">Settings</span>
                  </div>
                  <ChevronRight className="w-5 h-5 text-gray-400 group-hover:text-white transition-all" />
                </Link>
              </div>
