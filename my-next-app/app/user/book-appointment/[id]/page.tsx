...
export default function BookAppointmentPage() {
  ...
  const handleDateSelect = (day: number) => {
    ...
    const selectedDateObj = new Date(year, month, day, 12, 0, 0, 0)
    ...
    // Format correctly without timezone issues
  ...
  const renderCalendar = () => {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      // Format selected date correctly for comparison
            ...
            <div className="space-y-4 mt-6 pt-6 border-t border-gray-100">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 border-2 text-black border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#91C8E4] focus:border-[#4682A9] resize-none hover:border-gray-300 transition-colors"
                />
              </div>
            </div>
          </div>
